...
export const projectsData = [
  {
    ...
    info2: 'Technologies used: JavaScript, React.JS, Flux, Python, REST API, Bootstrap, and SCSS',
  ...
  },
  {
    ...
    info2:
      'Technologies used: JavaScript, React.JS, Flux, API, React-Router, Context, Props, Python, MySQL, Sass',
